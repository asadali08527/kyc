...
public class RetailerServiceImpl implements RetailerService {
	...
	public ResponseDTO getSummaries(RetailerRequestDTO retailerRequestDTO) {
		...
		return RetailersDtoHelper.getSummary(retailerRequestDTO);
	}
	...
	@Override
	public ResponseDTO submitDsrProfile(UserDTO userDTO) {
		...
		return RetailersDtoHelper.getLoginDTO(null, "SUCCESS", "200", null);
	}
