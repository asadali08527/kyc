...
public class AppDynamicFields implements Serializable {
	...
	@Column(name = "validation", length = 100, nullable = false, columnDefinition = "varchar(32) ")
	@Enumerated(value = EnumType.STRING)
	private InputType validation;
	...
	public InputType getValidation() {
		return validation;
	}

	public void setValidation(InputType validation) {
